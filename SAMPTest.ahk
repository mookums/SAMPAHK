...
; Sending a string to the debug.txt with sendToDebug() and logging the current conditions with logDebug() if the game is currently initalized.
NumPad9::
init := isGameIntialized()
if(init){
sendToDebug("Sample Text")
logDebug()
return
